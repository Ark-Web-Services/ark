...
export default function SeoInsights() {
  const articles = [
    { title: "Intent-led sitemaps: the secret to service business SEO", date: "March 20, 2024", readTime: "10 min read" },
    { title: "SEO vs Social Media: where should you invest in 2024?", date: "March 08, 2024", readTime: "8 min read" },
    { title: "How to rank for local service keywords without a blog", date: "February 22, 2024", readTime: "9 min read" },
    { title: "Keyword mapping for service businesses: a step-by-step guide", date: "February 10, 2024", readTime: "15 min read" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-16">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Foundational strategies for earning inbound traffic and scaling search visibility.
            </p>
          </div>
