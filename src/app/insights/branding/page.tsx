...
export default function BrandingInsights() {
  const articles = [
    { title: "How branding improves conversion on a website", date: "March 12, 2024", readTime: "7 min read" },
    { title: "The 3 pillars of effective brand positioning for consultants", date: "March 05, 2024", readTime: "9 min read" },
    { title: "Why messaging matters more than your logo", date: "February 20, 2024", readTime: "6 min read" },
    { title: "Creating a premium visual identity for a service business", date: "February 05, 2024", readTime: "11 min read" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-16">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              How to sharpen your positioning and build a brand that commands authority.
            </p>
          </div>
