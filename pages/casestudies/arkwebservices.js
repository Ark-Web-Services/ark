...
export default function f3pb() {
    return (
        <>
            <Head>
                <title>Portfolio - Ark Web Services</title>
            </Head>
                                ...
                                <div className="related-nav py-30">
                                    <div className="row justify-between items-center">
                                        ...
                                        <div className="col-md-auto col-6 d-flex justify-end">
                                            <Link href="/casestudies/seomagic" className="related-nav__item -prev text-right decoration-none">
                                                <div className="related-nav__content">
