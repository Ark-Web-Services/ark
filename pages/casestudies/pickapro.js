...
export default function Pickapro() {
    return (
        <>
            <Head>
                <title>Portfolio - Pick A Pro</title>
            </Head>
                                ...
                                <div className="related-nav py-30">
                                    <div className="row justify-between items-center">
                                        <div className="col-md-auto col-6">
                                            <Link href="/casestudies/seomagic" className="related-nav__item -prev decoration-none">
                                                ...
                                                <div className="related-nav__content">
                                                    ...
                                                    <p className="text-dark mt-8">SEO Magic</p>
                                                </div>
                                            </Link>
                                        </div>
                                        ...
                                        <div className="col-md-auto col-6 d-flex justify-end">
                                            <Link href="/casestudies/zalii" className="related-nav__item -prev text-right decoration-none">
                                                <div className="related-nav__content">
