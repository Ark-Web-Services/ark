...
export default function Providencecapital() {
    return (
        <>
            <Head>
                <title>Portfolio - SEO Magic</title>
            </Head>
                                ...
                                <div className="related-nav py-30">
                                    <div className="row justify-between items-center">
                                        <div className="col-md-auto col-6">
                                            <Link href="/casestudies/arkwebservices" className="related-nav__item -prev decoration-none">
                                                ...
                                                <div className="related-nav__content">
                                                    ...
                                                    <p className="text-dark mt-8">Ark Web Services</p>
                                                </div>
                                            </Link>
                                        </div>
                                        ...
                                        <div className="col-md-auto col-6 d-flex justify-end">
                                            <Link href="/casestudies/pickapro" className="related-nav__item -prev text-right decoration-none">
                                                <div className="related-nav__content">
