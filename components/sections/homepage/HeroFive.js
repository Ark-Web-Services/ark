                            ...
                            <div className="masthead__content md:text-center relative z-2">
                                <div data-split="lines">
                                    <h1 className="masthead__title">
                                        Web Design <br className="md:d-none" /> doesn't have to be <span className="text-accent">Complicated</span>
                                    </h1>
                                </div>
                                <div data-split="lines">
                                    <p className="masthead__text pt-24">
                                        
                                    In a world full of web agencies, we're a unique blend. <br className="sm:d-none" />You need more than just designers; you need tech allies,<br className="sm:d-none" /> creative partners, and friends. That's us!
                                    </p>
                                </div>
