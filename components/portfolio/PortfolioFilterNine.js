    ...
    return (
        <>
            ...
            <div className="works-row masonry -col-4 pt-60 sm:pt-40 js-masonry js-masonry-no-filter">
                        ...
                        <div className="ratio ratio-48:50 hover-group">
                            ...
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    ...
                                    <Link href="/casestudies/arkwebservices" className="absolute-full-center z-1" />
                                    <div className="text-center relative z-2">
                                        <div className="x-gap-10 y-gap-10">
                                            <a href="#" className="decoration-none">#webdesign</a>
                                        </div>
                ...
                <div className="masonry__item -no-ratio  web_design web_apps branding custom_dev">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            ...
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/casestudies/seomagic" className="absolute-full-center z-1" />
                                    <div className="text-center relative z-2">
                                        <div className="x-gap-10 y-gap-10">
                                            <a href="#" className="decoration-none">#custom</a>
                                            <a href="#" className="decoration-none">#webdesign</a>
                                            <a href="#" className="decoration-none">#webapps</a>
                                        </div>
                    ...
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            ...
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/casestudies/pickapro" className="absolute-full-center z-1" />
                                    <div className="text-center relative z-2">
                                        <div className="x-gap-10 y-gap-10">
                                            <a href="#" className="decoration-none">#custom</a>
                                            <a href="#" className="decoration-none">#webdesign</a>
                ...
                <div className="masonry__item -no-ratio  e_commerce web_design web_apps custom_dev">
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            ...
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/casestudies/zalii" className="absolute-full-center z-1" />
                                    <div className="text-center relative z-2">
                                        <div className="x-gap-10 y-gap-10">
                                            <a href="#" className="decoration-none">#custom</a>
                                            <a href="#" className="decoration-none">#ecommerce</a>
                                            <a href="#" className="decoration-none">#webdesign</a>
                                            <a href="#" className="decoration-none">#webapps</a>
                                        </div>
                    ...
                    <div>
                        <div className="ratio ratio-48:50 hover-group">
                            ...
                            <div className="px-10 py-10 absolute-full-center z-2 | opac-0 hg:opacity-100 t-base">
                                <div className="d-flex justify-center items-center w-1/1 h-1/1 relative">
                                    <div className="bg-white absolute-full-center" />
                                    <Link href="/casestudies/f3pb" className="absolute-full-center z-1" />
                                    <div className="text-center relative z-2">
                                        <div className="x-gap-10 y-gap-10">
