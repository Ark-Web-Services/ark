...
export default function Footer13() {
    return (
        <>
            <footer className="footer -type-3 rounded-tl-120 bg-dark-1" >
                        ...
                        <div className="row y-gap-48 justify-content-between">
                            <div className="col-lg-4 col-sm-6">
                                <div className="footer__item">
                                    ...
                                    <img src="/img/general/logo-flat.svg" alt="logo" style={{width: '101px', height: '50px'}} />
                                    </div>
                                    <div className="y-gap-32 pt-30">
                                        ...
                                        <div className="">
                                            ...
                                            <div className="text-xl fw-600 text-white">hi@zalii.com</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row justify-center py-30 border-top-light mt-120 md:mt-60">
                            <div className="col-auto">
                                <div className="footer__bottom_text text-white">
                                    © Copyright 2023. Zalii - All rights reserved.
                                </div>
                            </div>
                        </div>
                    </div>
