                    ...
                    <div className="container">
                            ...
                            <div className="col-lg-4 col-5">
                                <div className="footer__item">
                                    ...
                                    <p className="text-white mt-16">
                                        The #1 Custom Memory book for families <br /> who have loved ones with Alzheimer's
                                    </p>
                                    <div className="y-gap-32 pt-30">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-white text-xl fw-600">hi@zalii.com</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row justify-center items-center text-center pt-20 pb-80 sm:pb-30 mt-80">
                            <div className="col-auto">
                                ...
                                <div className="text-white mt-20">© Copyright 2023. Zalii - Web Design by Ark Web Services</div>
                            </div>
                        </div>
                    </div>
                </div>
